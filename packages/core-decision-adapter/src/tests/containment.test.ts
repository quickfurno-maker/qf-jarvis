 ...
 * `./testing`; the public API surface is locked; migrations 0001–0009 are byte-exact and there is no
 * 0010; the event-backbone public-api lock remains 39; production source holds no NUL/control byte;
