 ...
 * dependency; the public API is locked; migrations 0001–0008 are exact with no 0009; the event-backbone
...
describe('containment', () => {
  ...
  it('(67,68) migrations 0001–0008 are byte-exact and there is no 0009', () => {
