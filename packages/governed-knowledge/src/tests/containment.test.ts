 ...
 * dependency; the public API is locked; migrations 0001–0011 are exact with no 0013; the event-backbone
...
describe('containment', () => {
  ...
  it('(67,68) migrations 0001–0012 are byte-exact and there is no 0013', () => {
