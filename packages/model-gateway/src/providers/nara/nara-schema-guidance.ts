...
const INSTRUCTION: readonly string[] = Object.freeze([
  ...
  'Respect JSON primitive types exactly: booleans must be true/false, never quoted strings.',
  'Every array-typed property must be a JSON array; when it has no items, use [].',
  'Every enum value must match one of the schema values exactly.',
