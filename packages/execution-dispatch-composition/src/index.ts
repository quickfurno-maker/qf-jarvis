 ...
 * by mistake.
 *
 * It adopts NO transport and sends NOTHING: no URL, webhook, endpoint, QuickFurno Core Automation client, workflow id,
 * credential, provider, message or recipient. It creates no migration — 0010 belongs to P09.03 and
 * is reused unchanged — and grants no new authority to Jarvis, to QuickFurno Core Automation or to itself.
 *
