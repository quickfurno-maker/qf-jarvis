  ...
  Object.freeze({
    ...
    OUT_OF_SCOPE: [
      ...
      },
      {
        ...
        // PROCESS, not nothing. This slot requires GROUNDING_QA as a secondary, and in the reused P10
        // taxonomy a grounded question is one answered from governed knowledge WITH a citation. An
        // assignment demanding GROUNDING_QA while requiring no authority class was under-specified:
        // the author had to ground an answer in something the plan never supplied.
        //
