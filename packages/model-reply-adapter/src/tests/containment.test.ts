 ...
 * `./testing`; the public API is locked; migrations 0001–0007 are byte-exact with no 0008; the
...
describe('containment', () => {
  ...
  it('(75,76) migrations 0001–0007 are byte-exact and there is no 0008', () => {
