...
export const operatorModuleSchema = z
  .object({
    id: z.enum([
      'overview',
      'jarvis',
...
export const OPERATOR_MODULES = Object.freeze([
  ...
  },
  {
    ...
    group: 'AGENTS',
    label: 'Jarvis',
    scope: 'Orchestration and coordination',
    webPath: '/agents/jarvis',
    mobilePrimary: false,
  },
  {
    id: 'riya',
    group: 'AGENTS',
    label: 'Riya',
    scope: 'Customer conversation and qualification',
    webPath: '/agents/riya',
    mobilePrimary: false,
  },
  {
  ...
  },
  {
    ...
    scope: 'Human control and safety state',
    webPath: '/operations',
    mobilePrimary: true,
  },
  {
  ...
  },
  {
    ...
    group: 'OPERATE',
    label: 'Conversations',
    scope: 'Conversation inventory',
    webPath: '/conversations',
    mobilePrimary: false,
  },
  {
    id: 'execution',
    group: 'OPERATE',
    label: 'Execution',
    scope: 'Execution intent and dispatch readiness',
    webPath: '/execution',
    mobilePrimary: false,
  },
  {
  ...
  },
  {
    ...
    group: 'INTELLIGENCE',
    label: 'Memory',
    scope: 'Governed long-term memory policy and activation posture',
    webPath: '/memory',
    mobilePrimary: false,
  },
  {
    ...
    group: 'INTELLIGENCE',
    label: 'Digital Twin',
    scope: 'Zero-effect scenario replay and candidate comparison',
    webPath: '/simulation',
    mobilePrimary: false,
  },
  {
    ...
    group: 'INTELLIGENCE',
    label: 'Knowledge',
    scope: 'Governed knowledge namespaces',
    webPath: '/knowledge',
    mobilePrimary: false,
  },
  {
    ...
    group: 'INTELLIGENCE',
    label: 'Evaluations',
    scope: 'Suite health and readiness',
    webPath: '/evaluations',
    mobilePrimary: false,
  },
  {
    ...
    scope: 'Provider-neutral gateway',
    webPath: '/models',
    mobilePrimary: false,
  },
  {
    ...
    group: 'INTELLIGENCE',
    label: 'Workers',
    scope: 'Fleet topology and capacity',
    webPath: '/workers',
    mobilePrimary: false,
  },
  {
  ...
  },
  {
    ...
    scope: 'Exact release identity, assurance evidence, evaluation posture and rollout gate',
    webPath: '/release',
    mobilePrimary: false,
  },
  {
    ...
    group: 'BOUNDARY',
    label: 'Governance',
    scope: 'Roadmap, authority and audit posture',
    webPath: '/governance',
    mobilePrimary: false,
  },
  {
...
export const operatorCapabilitySchema = z
  .object({
...
export const operatorBootstrapSchema = z
  .object({
...
const conversation = <
  T extends 'CONVERSATION_TAKEOVER' | 'CONVERSATION_RESUME_AI' | 'CONVERSATION_PAUSE_AI',
>(
  action: T,
) =>
  z
...
export const operatorCommandResultSchema = z
  .object({
    protocol: z.literal(OPERATOR_COMMAND_PROTOCOL),
    commandId: uuid,
    status: z.enum([
