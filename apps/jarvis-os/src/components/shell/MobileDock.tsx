...
export function MobileDock() {
  ...
  return (
    <nav
      ...
      className="mobile-dock fixed inset-x-3 bottom-3 z-40 flex gap-1 overflow-x-auto rounded-[16px] border border-[var(--color-line-strong)] p-1.5 backdrop-blur-xl lg:hidden"
    >
      {ITEMS.map((item) => {
        ...
        return (
          <Link
            ...
            className={
              'flex min-w-[68px] flex-1 flex-col items-center gap-1 rounded-[11px] px-1 py-2 text-[9.5px] font-medium ' +
              (active
