...
export default function WorkersPage() {
  const workers = controlPlane().workers();
  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          {workers.map((worker) => (
            ...
            >
              ...
              <p className="mt-3">
                <Tag tone={worker.kind === 'control-plane' ? 'info' : 'planned'}>{worker.kind}</Tag>
              </p>
        ...
        <Panel title="Topology" subtitle="Where each node sits relative to the boundary">
          <DataTable
