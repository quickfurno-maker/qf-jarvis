/**
 * QF Jarvis — worker application boundary.
 *
 ...
 * no worker loop, no scheduler, no queue client, no event consumer, no startup
 * logging, and no imports.
 *
 ...
 *
 * The background-processing concerns this application will eventually carry —
 * event ingestion, agent runs, evaluation — arrive in their own phases, with
 * their own contracts and their own exit criteria. See
