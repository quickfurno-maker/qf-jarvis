...
**Scope:** qf-jarvis repository only. No Core, marketplace, OneDecore, QuickFurno Core Automation, Meta, provider, external
...
| C4 / S5 Core→QuickFurno Core Automation submission + durable fact | `BLOCKED_BY_EXTERNAL_AUTHORITY`                  | ADR-0137: `execution-submitted` "stays unresolved pending S5"                                                       |
...
| C4 / S5                   | Core / ADR-0132       | `execution-submitted` evidence    | `BLOCKED_BY_EXTERNAL_AUTHORITY`                                                            | ADR-0137: unresolved pending S5              | Core→QuickFurno Core Automation durable fact | **no**                  | artifact undefined                                 |
...
QuickFurno repository, Supabase project, OneDecore system, QuickFurno Core Automation workflow, Meta or provider endpoint,
