# Aarohi â€” Vendor Growth and Acquisition: QVGE capability overlay (AVG-0 â€¦ AVG-12)
...
**AVG identifiers are overlay ids owned by QFJ-P12 â€” Advanced Intelligence and Future Agents.**

They are **not** phases. They add no major phase, renumber nothing, and **there is no QFJ-P13**.
`QFJ-P00`â€“`QFJ-P12` are unchanged. An AVG id names a bounded capability slice so that future work can
...
| Field | Value |
| --- | --- |
| Canonical agent | **Aarohi â€” Vendor Growth and Acquisition Agent** |
| Subsystem | **QuickFurno Vendor Growth Engine (QVGE)** |
| Jarvis OS section | **Aarohi â€” Vendor Growth** |
| Historical alias | `ANI-COLD-AQUI` â€” **non-canonical / retired**; never an identifier, capability id, namespace or routing key |
...
it** â€” not at conversation topic, not at channel, and not at which agent spoke first.
...
authoritative confirmation â€” never a provider receipt, a model's reading of a conversation, or a
...
- **Aarohi never mutates QuickFurno marketplace tables**, and never calls a provider or n8n directly.
  Approved execution goes Core/human â†’ n8n â†’ provider.
- **Commercial truth â€” packages, entitlements, pricing, discounts, offers â€” comes from Core**, never
...
### AVG-0 â€” Architecture and Governance
...
### AVG-1 â€” Prospect Identity and Acquisition Case Domain
...
### AVG-2 â€” Discovery and Enrichment
Sourcing candidate businesses and enriching them into a reviewable profile. Enriched content is
**untrusted reference material** â€” it never establishes consent, never proves identity, and never
...
[ADR-0111](../decisions/ADR-0111-qfj-p12-avg2-aarohi-discovery-enrichment-domain.md)** â€” contracts and
...
### AVG-3 â€” Scoring and Outreach Eligibility
Ranking prospects, and â€” separately â€” deciding whether outreach is permitted at all. **Scoring and
...
### AVG-5 â€” Instagram Conversation Integration
...
### AVG-6 â€” Omnichannel Identity and WhatsApp Handoff
...
### AVG-7 â€” Aarohi Sales Brain
The conversation and objection-handling behaviour for acquisition. Bounded by the same sales-ethics
prohibitions as Anisha, and by the rule that **the brain proposes and Core disposes** â€” no commercial
commitment originates in the model.

### AVG-8 â€” Commercial Truth and Package Engine
...
### AVG-9 â€” Registration Integration
...
### AVG-10 â€” Payment, Activation and Anisha Handoff
...
### AVG-11 â€” Analytics, Admin APIs and Full Dashboard
...
### AVG-12 â€” Scale, Evaluation and Controlled Autonomy
Volume, evaluation suites, red-team coverage and any increase in autonomy â€” each governed by the
