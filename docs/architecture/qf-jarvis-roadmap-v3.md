...
- **QFJ-P03.07 (Projection Failure Operations, historical Stage 3.5) is in progress.** QFJ-P03.07A (design, [ADR-0040](../decisions/ADR-0040-projection-failure-operations-quarantine-and-authorized-replay.md), SCHEMA_REQUIRED), QFJ-P03.07B (failure contracts and taxonomy), **QFJ-P03.07C (Failure Persistence Foundation)**, and **QFJ-P03.07D (Atomic Retry-Exhaustion Integration)** are merged and locked (QFJ-P03.07C via PR #30, merge commit `43137a551c70a09311fcd1815a7a1ce2718a12ba`; QFJ-P03.07D via PR #31, merge commit `8c040a9c82268af54665740985782cad9b2e0fef`). **QFJ-P03.07E (Failure Inspection and Quarantine Operations) is implemented on its branch:** an internal operations boundary adds authorized, bounded failure inspection/history/divergence inspection plus the acknowledge and quarantine lifecycle mutations (generation-guarded, idempotent, atomic, divergence-gated); quarantine preserves the blocked checkpoint and never advances, resolves, skips, or replays. **Replay authorization and replay execution remain deferred (QFJ-P03.07F next).**
...
**Immediate next slice:** QFJ-P03.07F — Authorized Replay Execution (following the merged QFJ-P03.07A–D and the QFJ-P03.07E inspection/quarantine operations implemented on-branch). No MVP runtime (M1) has begun.
