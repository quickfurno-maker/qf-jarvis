...
| Subphase | Name | Historical alias |
| --- | --- | --- |
| **QFJ-P04.01** | Model Gateway (foundation **QFJ-P04.01A** + hosted adapter **QFJ-P04.01B** + local adapter **QFJ-P04.01C** merged; hybrid routing **QFJ-P04.01D** implemented on a feature branch / draft PR, [ADR-0048](../decisions/ADR-0048-qfj-p04-01d-hybrid-routing-and-failover.md), not merged) | Stage 4.0 |
