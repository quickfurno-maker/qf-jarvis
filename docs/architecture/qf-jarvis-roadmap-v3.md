...
| **QFJ-P03.09** | Subject Activity Projection ([ADR-0044](../decisions/ADR-0044-qfj-p03-09-subject-activity-projection.md), migration 0007; implementation on a feature branch / draft PR, not merged) | deferred `rm_subject_activity` |
