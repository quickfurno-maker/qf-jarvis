...
5. **Success** atomically: apply the projection change, advance the checkpoint once, record successful attempt evidence, resolve the failure, and consume/close the authorization.
